  ...
  "Statement": [
    {
      ...
      "Principal": {
        "AWS": [
          ...
          "arn:aws:iam::458132236648:user/circleci"
        ]
      },
      "Action": [
...
DOREMOTE=false
if [[ ! -z $CIRCLE_BUILD_NUM && ( $CIRCLE_BRANCH == "develop" || $CIRCLE_BRANCH == "master" || $CIRCLE_BRANCH == "main" || $CIRCLE_BRANCH == feature/* || $CIRCLE_BRANCH == release* ) ]]; then
	DOREMOTE=true
fi
